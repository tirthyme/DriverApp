        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (model.getAccepted().equals("yes")) {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(holder.context).setTitle("Confirmation..").setMessage("Are you sure you wan't to start your navigation?")
                            .setPositiveButton("Okaay", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    FirebaseFirestore.getInstance().collection("requests_master").document(model.getId()).update("accepted", "yes","driver_onWay","yes").addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                    ...
                    AlertDialog.Builder dialog = new AlertDialog.Builder(holder.context).setTitle("Wait a moment..").setMessage("Do you want to accept this request?")
                            .setPositiveButton("Yes.", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(final DialogInterface dialog, int which) {
                                    FirebaseFirestore.getInstance().collection("requests_master").document(model.getId()).update("accepted", "yes")
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Toast.makeText(holder.context, "Request accepted", Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();
                                        }
                                    });
                                }
