...
public class Request {
    ...
    public Request(String id,String accepted, String clientID, String driverID, String client_onWay, String driver_onWay, String meetingpointID, Map<String, String> client_info, Map<String, String> driver_info, Map<String, String> meetingpoint_info, Timestamp request_time) {
        this.id = id;
